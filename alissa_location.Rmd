...
This section presents interactive maps that visually display geographic differences in shooting incidents across boroughs. Points are clustered for improved performance; click on clusters to zoom in and view individual incidents.

## 3a. Map of Total Shootings by Borough (All Years)

This map shows all shooting incidents from 2006 through 2025 as clustered points overlaid on borough boundaries.
...
* **Comments**
Each red point represents an individual shooting incident. Points are clustered for visualization; click clusters to zoom in and see individual locations. The geographic concentration in Brooklyn and the Bronx is clearly visible. The borough shading indicates total counts, while clustered points show the spatial distribution of incidents.
