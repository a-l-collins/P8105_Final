...
*some kind of introductory image here*

### **Effect of the time of day**

Do we see more shootings during the day or night, and during which hours of the day?

```{r figures_hour, fig.show='hold', out.width="50%", message = FALSE, warning = FALSE}
...
```{r figures_day, fig.show='hold', out.width="50%", message = FALSE, warning = FALSE}
#' Read in calendar
#'
...
Do shooting rates differ between months? We found that it did, and compared this information against a temperature histogram to corroborate the spike in shootings that we saw.

```{r figures_month, fig.show='hold', out.width="50%", message = FALSE, warning = FALSE}
...
Have shooting rates changed over the years, and did the COVID-19 pandemic impact shooting rates at all? We found that there was a decline in shooting rates between 2006 and 2020, at which point there was a spike in shooting rates which has yet to recover to its pre-pandemic rates.

```{r figures_year, fig.show='hold', out.width="50%", message = FALSE, warning = FALSE}
